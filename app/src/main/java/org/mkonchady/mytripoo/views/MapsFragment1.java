...
public class MapsFragment1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.fragment_maps1, container, false);
        FrameLayout frameLayout = v.findViewById(R.id.map1);
    ...
    private void checkMapLoaded() {
        if (!loadedTrip && !tripCompareView.upIncomplete) {
            mapTrip = (TreeMap) tripCompareView.upTrip.clone();
            loadedTrip = true;
        }
    }
        ...
        protected String doInBackground(Object... params) {
            ...
            for(Long timeKey: keySet) {
                ...
                if (firstTime == 0) {
                    ...
                    polylineOptions.add(new LatLng(prev_lat, prev_lon)).color(redColor);
                    polylineOptions.add(new LatLng(curr_lat, curr_lon)).color(redColor);
                    prev_lat = curr_lat;
                    prev_lon = curr_lon;
                }
                lastTime = timeKey;
            ...
            tripCompareView.setUpDistance(cum_distance);
            ...
            if (currentTime + TIME_INCR >= MAX_DURATION / 1000) {
                ...
                polylineOptions.add(new LatLng(tm.getLat() / Constants.MILLION, tm.getLon() / Constants.MILLION)).color(redColor);
            }
